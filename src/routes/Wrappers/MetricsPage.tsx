...
import Desviacion from "../../Components/Desviacion/Desviacion";
...
/**
 * Carga el proyecto solicitado por ruta y muestra la vista de métricas.
 * @param props - Proyecto actual y función para actualizar la selección global.
 * @returns Vista de métricas o un estado de carga/error según corresponda.
 */
export function MetricsPage({ setSelectedProject, project }: Props) {
  ...
  return <Desviacion project={project} />;
}
