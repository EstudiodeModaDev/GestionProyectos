 ...
 * @typeParam TCreate - Estructura requerida para crear registros.
 * @typeParam TUpdate - Estructura permitida para actualizar registros.
 */
export abstract class BaseSharePointListService<TModel, TCreate = Omit<TModel, "ID">, TUpdate = Partial<Omit<TModel, "ID">>> {
  ...
  /**
   * Inicializa una nueva instancia del servicio base de listas.
   * @param graph - Cliente para realizar peticiones a Microsoft Graph.
   * @param hostname - Host del sitio de SharePoint.
   * @param sitePath - Ruta relativa del sitio dentro del host.
   * @param listName - Nombre visible de la lista de SharePoint.
   */
  constructor(
    graph: GraphRest,
    hostname: string,
  ...
  /**
   * Convierte un elemento bruto de Graph al modelo de dominio.
   * @param item - Elemento devuelto por Microsoft Graph.
   * @returns Modelo transformado.
   */
  protected abstract toModel(item: any): TModel;

  /**
   * Obtiene la clave de caché usada para almacenar identificadores resueltos.
   * @returns Clave única por sitio y lista.
   */
  ...
  /**
   * Carga desde `localStorage` los identificadores del sitio y de la lista.
   */
  ...
  /**
   * Guarda en caché los identificadores resueltos del sitio y de la lista.
   */
  ...
  /**
   * Resuelve y cachea los identificadores del sitio y de la lista.
   ...
   * @returns Modelo resultante después de la creación.
   */
  ...
  /**
   * Actualiza los campos de un elemento existente.
   * @param id - Identificador del elemento.
   * @param changed - Campos a modificar.
   * @returns Modelo actualizado.
   */
   ...
   * @param id - Identificador del elemento.
   * @returns Modelo correspondiente al elemento solicitado.
   */
  ...
  /**
   * Obtiene una página de resultados de la lista.
   * @param opts - Opciones de filtrado, orden y paginación.
   * @returns Página de resultados y enlace a la siguiente página si existe.
   */
  ...
  /**
   * Obtiene una página a partir de un `nextLink` devuelto por Microsoft Graph.
   * @param nextLink - URL absoluta de continuación.
   * @returns Página de resultados asociada al enlace.
   */
  ...
  /**
   * Recupera y transforma una página de resultados.
   * @param url - Ruta relativa o absoluta a consultar.
   * @param isAbsolute - Indica si `url` debe resolverse como absoluta.
   * @returns Página normalizada del servicio.
   */
  ...
  /**
   * Obtiene todos los elementos de la consulta actual como un arreglo plano.
   * @param opts - Opciones de filtrado, orden y límite.
   * @returns Colección de modelos transformados.
   */
